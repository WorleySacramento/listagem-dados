    ...
    <div className="max-w-[1200px] mx-auto flex items-center justify-between">
      ...
      <div className="flex items-center gap-3">
        <div className="flex flex-col items-end gap-0.5">
          <span className="text-sm font-medium">Worley Sacramento</span>
          <span className="text-xs text-zinc-400">worleysacramento@gmail.com</span>
        </div>
        <img
          src="https://avatars.githubusercontent.com/u/78088577?s=400&u=79228cae2c94587510499e596c9642111316528a&v=4"
